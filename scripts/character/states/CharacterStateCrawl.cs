...
public class CharacterStateCrawl : ICharacterState
{
    ...
    public ICharacterState ChangeState()
    {
        ...
        else if (faceOn.ClimbableEntity.Destroyed || characterData.HasLostGrip() || (!characterData.IsStunned() && !characterData.Controller.GripInput()) || (!characterData.IsStunned() && !validCrawlFace))
        {
